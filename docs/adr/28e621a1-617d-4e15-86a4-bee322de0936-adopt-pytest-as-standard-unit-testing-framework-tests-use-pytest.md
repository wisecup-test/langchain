...
1. MAY: Tests MAY use pytest fixtures, parametrization, and plugins to enhance test capabilities

## Policy Block

- MAY Tests MAY use pytest fixtures, parametrization, and plugins to enhance test capabilities
