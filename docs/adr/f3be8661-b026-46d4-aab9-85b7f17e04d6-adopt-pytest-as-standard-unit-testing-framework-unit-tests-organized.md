...
1. SHOULD: Unit tests SHOULD be organized by component type (e.g., chat_models, embeddings, imports) in subdirectories

## Policy Block

- SHOULD Unit tests SHOULD be organized by component type (e.g., chat_models, embeddings, imports) in subdirectories
