...
1. MUST: Unit tests for internal APIs MUST NOT require live external service connections

## Policy Block

- MUST Unit tests for internal APIs MUST NOT require live external service connections
