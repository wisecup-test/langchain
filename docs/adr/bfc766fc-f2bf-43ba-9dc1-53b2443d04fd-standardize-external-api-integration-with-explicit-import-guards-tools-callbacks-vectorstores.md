...
1. MUST: Tools, callbacks, and vectorstores that depend on external APIs MUST document their optional dependencies in docstrings or class-level comments

## Policy Block

- MUST Tools, callbacks, and vectorstores that depend on external APIs MUST document their optional dependencies in docstrings or class-level comments
