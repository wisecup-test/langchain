...
1. SHOULD: API contract tests SHOULD be executed as part of the continuous integration pipeline before merging changes

## Policy Block

- SHOULD API contract tests SHOULD be executed as part of the continuous integration pipeline before merging changes
