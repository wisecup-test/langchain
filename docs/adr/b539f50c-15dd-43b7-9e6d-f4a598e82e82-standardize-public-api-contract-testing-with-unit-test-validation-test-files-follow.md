...
1. SHOULD: Test files SHOULD follow the naming convention 'test_*.py' and be organized in 'unit_tests' or 'tests/unit_tests' directories

## Policy Block

- SHOULD Test files SHOULD follow the naming convention 'test_*.py' and be organized in 'unit_tests' or 'tests/unit_tests' directories
