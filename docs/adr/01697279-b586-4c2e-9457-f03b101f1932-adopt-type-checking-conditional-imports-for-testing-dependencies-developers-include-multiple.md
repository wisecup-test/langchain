...
1. MAY: Developers MAY include multiple conditional import blocks for different categories of optional dependencies (testing, development tools, optional integrations)

## Policy Block

- MAY Developers MAY include multiple conditional import blocks for different categories of optional dependencies (testing, development tools, optional integrations)
