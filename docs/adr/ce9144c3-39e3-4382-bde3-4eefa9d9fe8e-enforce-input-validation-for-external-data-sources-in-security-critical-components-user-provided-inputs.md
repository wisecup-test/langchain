...
1. MUST: User-provided inputs including prompts, configuration parameters, and callback handlers MUST be sanitized and validated against expected formats

## Policy Block

- MUST User-provided inputs including prompts, configuration parameters, and callback handlers MUST be sanitized and validated against expected formats
