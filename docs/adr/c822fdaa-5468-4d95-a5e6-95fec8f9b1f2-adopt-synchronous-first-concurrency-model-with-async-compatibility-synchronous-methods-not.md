...
1. MUST_NOT: Synchronous methods MUST NOT block the event loop when called from async contexts without explicit documentation

## Policy Block

- MUST_NOT Synchronous methods MUST NOT block the event loop when called from async contexts without explicit documentation
