...
1. MUST: Import failures for optional external API dependencies MUST raise ImportError with clear messages indicating which package needs to be installed

## Policy Block

- MUST Import failures for optional external API dependencies MUST raise ImportError with clear messages indicating which package needs to be installed
