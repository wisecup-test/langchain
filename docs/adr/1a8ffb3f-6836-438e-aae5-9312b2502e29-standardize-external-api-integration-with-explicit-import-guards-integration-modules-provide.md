...
1. MAY: Integration modules MAY provide type stubs or protocol definitions that work without the external dependency installed

## Policy Block

- MAY Integration modules MAY provide type stubs or protocol definitions that work without the external dependency installed
