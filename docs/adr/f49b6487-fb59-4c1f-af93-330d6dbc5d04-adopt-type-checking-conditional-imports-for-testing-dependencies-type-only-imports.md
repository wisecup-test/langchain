...
1. MUST: All type-only imports from testing frameworks or optional dependencies MUST be placed within a `if TYPE_CHECKING:` conditional block

## Policy Block

- MUST All type-only imports from testing frameworks or optional dependencies MUST be placed within a `if TYPE_CHECKING:` conditional block
