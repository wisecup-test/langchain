...
1. SHOULD: External client configuration SHOULD be centralized in dedicated modules separate from business logic

## Policy Block

- SHOULD External client configuration SHOULD be centralized in dedicated modules separate from business logic
