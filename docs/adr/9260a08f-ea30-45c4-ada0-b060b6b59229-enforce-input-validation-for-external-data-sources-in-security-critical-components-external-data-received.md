...
1. MUST: All external data received from AI model providers (Ollama, OpenAI, etc.) MUST be validated for type correctness and schema compliance before processing

## Policy Block

- MUST All external data received from AI model providers (Ollama, OpenAI, etc.) MUST be validated for type correctness and schema compliance before processing
