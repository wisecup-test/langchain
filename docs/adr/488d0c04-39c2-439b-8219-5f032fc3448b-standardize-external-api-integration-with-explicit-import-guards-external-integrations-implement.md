...
1. SHOULD: External API integrations SHOULD implement import guards that allow the module to be imported even when the external dependency is unavailable

## Policy Block

- SHOULD External API integrations SHOULD implement import guards that allow the module to be imported even when the external dependency is unavailable
