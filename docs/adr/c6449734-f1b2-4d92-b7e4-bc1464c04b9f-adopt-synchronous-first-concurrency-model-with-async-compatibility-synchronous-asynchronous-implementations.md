...
1. MUST: Synchronous and asynchronous implementations MUST maintain functional parity and consistent behavior

## Policy Block

- MUST Synchronous and asynchronous implementations MUST maintain functional parity and consistent behavior
