...
1. MUST_NOT: Runtime code MUST NOT directly reference types imported under TYPE_CHECKING blocks without string annotations or forward references

## Policy Block

- MUST_NOT Runtime code MUST NOT directly reference types imported under TYPE_CHECKING blocks without string annotations or forward references
