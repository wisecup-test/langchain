...
1. MUST: API documentation MUST clearly indicate which methods are synchronous, asynchronous, or both

## Policy Block

- MUST API documentation MUST clearly indicate which methods are synchronous, asynchronous, or both
