...
1. MUST: The TYPE_CHECKING constant MUST be imported from the typing module at the top of files using conditional type imports

## Policy Block

- MUST The TYPE_CHECKING constant MUST be imported from the typing module at the top of files using conditional type imports
