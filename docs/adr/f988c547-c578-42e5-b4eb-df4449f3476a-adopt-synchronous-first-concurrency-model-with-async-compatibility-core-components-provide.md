...
1. MUST: All core components MUST provide synchronous interfaces as the primary API surface

## Policy Block

- MUST All core components MUST provide synchronous interfaces as the primary API surface
