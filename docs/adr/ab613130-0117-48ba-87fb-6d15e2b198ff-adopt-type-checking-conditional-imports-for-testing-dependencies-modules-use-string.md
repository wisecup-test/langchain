...
1. SHOULD: Modules SHOULD use string literals for type annotations when referencing types from TYPE_CHECKING imports in function signatures

## Policy Block

- SHOULD Modules SHOULD use string literals for type annotations when referencing types from TYPE_CHECKING imports in function signatures
