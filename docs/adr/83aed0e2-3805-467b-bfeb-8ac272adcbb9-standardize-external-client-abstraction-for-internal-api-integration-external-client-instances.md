...
1. MUST: External client instances MUST be injectable to enable testing with mocks and stubs

## Policy Block

- MUST External client instances MUST be injectable to enable testing with mocks and stubs
