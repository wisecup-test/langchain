...
1. SHOULD: Error messages for missing dependencies SHOULD include installation instructions (e.g., 'pip install package-name')

## Policy Block

- SHOULD Error messages for missing dependencies SHOULD include installation instructions (e.g., 'pip install package-name')
