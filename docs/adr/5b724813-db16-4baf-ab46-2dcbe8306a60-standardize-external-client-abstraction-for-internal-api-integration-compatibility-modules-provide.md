...
1. MAY: Compatibility modules MAY provide fallback implementations for deprecated external client methods

## Policy Block

- MAY Compatibility modules MAY provide fallback implementations for deprecated external client methods
