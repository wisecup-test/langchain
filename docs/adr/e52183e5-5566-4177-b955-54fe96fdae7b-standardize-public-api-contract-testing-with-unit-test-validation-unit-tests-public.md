# Standardize Public API Contract Testing with Unit Test Validation: Unit Tests Public
...
1. MUST: Unit tests for public APIs MUST verify input validation, output formats, and error handling behavior

## Policy Block

- MUST Unit tests for public APIs MUST verify input validation, output formats, and error handling behavior
