# Standardize Public API Contract Testing with Unit Test Validation: Teams Implement Additional
...
1. MAY: Teams MAY implement additional integration tests beyond unit tests for end-to-end API validation

## Policy Block

- MAY Teams MAY implement additional integration tests beyond unit tests for end-to-end API validation
