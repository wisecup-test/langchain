...
1. SHOULD: Failed validation attempts SHOULD be logged with sufficient detail for security monitoring while avoiding exposure of sensitive data

## Policy Block

- SHOULD Failed validation attempts SHOULD be logged with sufficient detail for security monitoring while avoiding exposure of sensitive data
