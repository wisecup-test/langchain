...
1. MUST: Partner integration libraries (e.g., OpenAI, Ollama, Nomic) MUST implement standard unit tests covering embeddings, chat models, and client utilities

## Policy Block

- MUST Partner integration libraries (e.g., OpenAI, Ollama, Nomic) MUST implement standard unit tests covering embeddings, chat models, and client utilities
