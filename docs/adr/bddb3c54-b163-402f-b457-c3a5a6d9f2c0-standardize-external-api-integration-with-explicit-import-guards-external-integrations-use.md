...
1. MUST: External API integrations MUST use lazy imports with explicit try-except blocks to handle missing dependencies

## Policy Block

- MUST External API integrations MUST use lazy imports with explicit try-except blocks to handle missing dependencies
