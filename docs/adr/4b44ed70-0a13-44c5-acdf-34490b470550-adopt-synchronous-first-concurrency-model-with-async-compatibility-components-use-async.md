...
1. SHOULD: Components SHOULD use async as the underlying implementation with sync wrappers where performance permits

## Policy Block

- SHOULD Components SHOULD use async as the underlying implementation with sync wrappers where performance permits
