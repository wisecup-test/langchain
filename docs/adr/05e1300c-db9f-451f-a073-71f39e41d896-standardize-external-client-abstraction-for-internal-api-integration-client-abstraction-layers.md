...
1. MUST: Client abstraction layers MUST handle version compatibility concerns for external SDKs

## Policy Block

- MUST Client abstraction layers MUST handle version compatibility concerns for external SDKs
